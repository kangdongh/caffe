...
ResNet101Body(net, from_layer='data', use_dilation_conv5=True, use_pool5=False)
...
ResNet101Body(net, from_layer='data', use_dilation_conv5=True, use_pool5=False, use_global_stats=True)

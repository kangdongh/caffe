...
solver_param = {
    ...
    'weight_decay': 0.0005,
    'lr_policy': "multistep",
    'stepvalue': [640000, 800000, 960000],
    'gamma': 0.1,
    'momentum': 0.9,
    'iter_size': iter_size,
    'max_iter': 960000,
...
ResNetBody(net, from_layer='data', num_layer=50 , use_dilation_conv4=True, use_dilation_conv5=True, conv5_dilated=4, use_pool5=False)
...
ResNetBody(net, from_layer='data', num_layer=50, use_dilation_conv4=True, use_dilation_conv5=True, conv5_dilated=4, use_pool5=False, use_global_stats=True)
